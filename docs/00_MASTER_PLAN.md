...
(`docs/adr/ADR-0012-ninth-batch-of-seven-after-finishing-the-eighth.md`); the tenth is days
...
(`docs/adr/ADR-0015-twelfth-batch-of-two-to-the-proofreading-checklist.md`); the thirteenth is
days 114–115, two days inside phase 6 and crossing no gate
(`docs/adr/ADR-0016-thirteenth-batch-of-two-first-rehearsal-and-draft.md`). A batch
...
It is not a precedent. The cap stays ten, and any batch over ten needs its own ADR and a choice
made by the learner with the cap stated (ADR-0009).
